...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] p-4 text-white shadow-[0_10px_25px_-8px_rgba(37,211,102,0.6)] transition-transform hover:scale-105"
